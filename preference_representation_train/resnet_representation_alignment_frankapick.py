...
for data_size in data_size_set:
        ...
        with torch.no_grad():
            ...
            for i in range(0, eval_size, set_batch_size):
                ...
                if enable_equal_ranking:
                    ...
                    current_batch_equal = get_batch_data('equal_ranking', sequence_length, equal_ranking_data_dir, current_batch_qual_indexs) # B x 3 x T x 3 x 224 x 224
    ...
    for epoch in range(50):
        ...
        val_loss = eval_batch(eval_contrastive_ranking_indexs)
        obs_encoder.train()
        if enable_feature_aligner:
            feature_aligner.train()
        print('Validation loss: %.3f' % val_loss)
        encoder_save_name = '8_30_resnet_franka_push_obs_encoder_datasize' + str(data_size) +'.pt'
